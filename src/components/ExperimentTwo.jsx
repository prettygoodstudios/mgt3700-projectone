    ...
    render(){
        return (
            <div className="experiment-two section">
                <h1 className="section__header">Now that you know a little about
processes try to identify the problem?</h1>
                ...
                <div className="experiment-two__options">
                    <div className="experiment-two__options__option">
                        ...
                        <div className="experiment-two__options__option__answer">
                            Sike, you made the same mistake Elon made at the Tesla Model 3 Production Line.
                    ...
                    <div className="experiment-two__options__option">
                        ...
                        <div className="experiment-two__options__option__answer">
                            Correct, Station B is being fully utilized due to the work in progres (WIP) building up behind it. WIP is inventory that is sitting idle in the production process. Therefore, Station B is the bottleneck. Option one is a poor choice, since increasing the production of station A would only lead to additional WIP.
                        </div>
                    </div>
                </div>
            </div>
